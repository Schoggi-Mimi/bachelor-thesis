...
\begin{table*}[!t]
    ...
    \toprule
        ...
        & MDID2016 \cite{MDID2016} & 2016 & 20 & 1600 & GB or CC ﬁrst, JPEG or JP2K second and WN last& - & 512 $\times$ 384 & MOS \\
        \hline
    ...
    \begin{tabular}{l}
        Note: \#Ref.: Total number of pristine images. \quad \#Dist.: Total number of distorted images. \quad JPEG: JPEG compression. \quad JP2K: JPEG2000 compression. \\ 
         ...
         \quad  \quad  \quad LSBC.: Layer segmentation based compression. \quad HEVC-SCC: Screen content coding extension of high eﬃciency video coding. 
    \end{tabular}
    }
\end{table*}
