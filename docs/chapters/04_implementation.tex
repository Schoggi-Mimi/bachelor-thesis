...
\end{figure}
\noindent
These histograms provide valuable insights into the commonality and impact of each type of distortion, helping analyze how distortions affect overall image quality. They also highlight the criteria that may need more attention during the model training and validation process.\todo{mention further what i see in the plot.} \par
